...
withjQuery(function($){
	...
	route("confirmPassengerAction.do", function() {
		...
		if($("#refreshButton").size()<1){
			...
			$(".tj_btn").append($("<button style='padding: 5px 15px; background: #2CC03E;border-color: #259A33;border-right-color: #2CC03E;border-bottom-color:#2CC03E;color: white;border-radius: 5px;text-shadow: -1px -1px 0 rgba(0, 0, 0, 0.2);'/>").attr("id", "refreshButton").html("自动提交订单").click(function() {
